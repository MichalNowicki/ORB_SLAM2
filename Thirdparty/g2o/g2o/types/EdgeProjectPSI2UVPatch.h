...
#ifndef ORB_SLAM2_EDGEPROJECTPSI2UVPATCH_H
#define ORB_SLAM2_EDGEPROJECTPSI2UVPATCH_H
...
//        //  x x
//        //   x
//        std::vector<std::pair<double, double>> neighbours = {{0,0}, {0,2}, {1,1}, {2,0}, {1,-1}, {0,-2}, {-1,-1}, {-2,0}, {-1,1}};

    };
}

#endif //ORB_SLAM2_EDGEPROJECTPSI2UVPATCH_H