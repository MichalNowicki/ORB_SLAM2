...
#ifndef ORB_SLAM2_EDGEPROJECTPSI2UVSINGLEPARAM_H
#define ORB_SLAM2_EDGEPROJECTPSI2UVSINGLEPARAM_H
...
namespace g2o {
    ...
    class EdgeProjectPSI2UVSingleParam : public  g2o::BaseMultiEdge<2, Vector2D>
    {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW

        EdgeProjectPSI2UVSingleParam()  {
            resizeParameters(1);
...
#endif //ORB_SLAM2_EDGEPROJECTPSI2UVSINGLEPARAM_H
