...
#include "EdgeProjectPSI2UVPatch.h"
...
//    bool EdgeProjectPSI2UVPatch::write(std::ostream &os) const {
//        os << _cam->id() << " ";
//        for (int i = 0; i < 2; i++) {
//            os << measurement()[i] << " ";
//        }
...
//    }
//
//    bool EdgeProjectPSI2UVPatch::read(std::istream &is) {
//        int paramId;
//        is >> paramId;
...
//    }
//
//    void EdgeProjectPSI2UVPatch::computeError() {
...
//
//        Vector2D projectedPosInAnchor =  cam->cam_map(invert_depth(psi->estimate()));
//        Vector2D projectedPosInObs =  cam->cam_map(T_p_from_world->estimate()
//                                    * T_anchor_from_world->estimate().inverse()
//                                    * invert_depth(psi->estimate()));
//
//        double sumOfErrors = 0;
//        for (auto n : neighbours) {
//            Vector2D patchShift = Vector2D(n.first, n.second);
//            Vector2D pointInAnchor = projectedPosInAnchor + patchShift;
//            Vector2D pointInObs = projectedPosInObs + patchShift;
//
//            // TODO
//            // 1. Pixel value for points
//            // 2. Diff between pixels
//            // 3. Filling the error
//
//        }
//
//        _error; // It will have the size of the patch
//    }
//
//    inline Matrix<double, 2, 3, Eigen::ColMajor>
//    EdgeProjectPSI2UVPatch::d_proj_d_y(const double &fx, const double &fy, const Vector3D &xyz) {
...
//    }
//
//    inline Matrix<double, 3, 6, Eigen::ColMajor> EdgeProjectPSI2UVPatch::d_expy_d_y(const Vector3D &y) {
...
//    }
//
//    inline Matrix3D EdgeProjectPSI2UVPatch::d_Tinvpsi_d_psi(const SE3Quat &T, const Vector3D &psi) {
...
//    }
//
//    void EdgeProjectPSI2UVPatch::linearizeOplus() {
...
//    }
//
//    bool EdgeProjectPSI2UVPatch::isDepthPositive() {
